...
practical 7:You have a business with several offices; you want to lease phone lines to connect them up with 
each other; and the phone company charges different amounts of money to connect different pairs
of cities. You want a set of lines that connects all your offices
...
1
*******INPUT YOUR VALUES*******
Enter the no. of branches: 3

Enter the no. of connections: 2
Enter the end branches of connections:  
1
2
Enter the phone company charges for this connection:  233
Enter the end branches of connections:  
2
3
Enter the phone company charges for this connection:  26
==========PRIM'S ALGORITHM=================
...
3
*********MINIMUM************
Minimum cost connection is1 -> 2  with charge : 233
Minimum cost connection is2 -> 3  with charge : 26
The minimum total cost of connections of all branches is: 259*/
